...
if(!defined('MagicZoomPlusModuleCoreClassLoaded')) {
    ...
    class MagicZoomPlusModuleCoreClass {
        ...
        function headers($jsPath = '', $cssPath = null, $notCheck = false) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Plus OpenCart module version v3.1.23 [v1.4.14:v4.5.38] -->';
        ...
        function template($params) {
            ...
            return "<a{$link} class=\"MagicZoomPlus\"{$title} id=\"MagicZoomPlusImage{$id}\" href=\"{$img}\" {$rel}><img itemprop=\"image\"{$width}{$height} src=\"{$thumb}\" alt=\"{$alt}\" />{$description}</a><br />{$message}{$tap}";
        }
