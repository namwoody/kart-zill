<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v3.1.23' || 'working' == 'v4.5.38') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v4.5.38&module_version=v3.1.23&platform_name=opencart&platform_version={$platformVersion}&url={$url}";
